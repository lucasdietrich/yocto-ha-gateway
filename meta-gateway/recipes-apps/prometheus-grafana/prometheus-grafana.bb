...
SRC_URI = "file://init-podman-grafana-stack.sh \
           ...
           file://grafana/dashboards/ble-linky-dashboard.json \
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/grafana/dashboards/ble-linky-dashboard.json ${D}/opt/prometheus-grafana/grafana/dashboards/
